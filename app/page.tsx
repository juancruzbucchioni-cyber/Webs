...
const plans = [
  {
    ...
    features: [
      ...
      "Hasta 300 productos con carga inicial incluida",
      "El cliente proporciona el logo, fotos, textos y precios",
      ...
      "Después de los 2 años, el hosting se renueva con pago",
      "Dominio privado disponible por separado con pago anual",
      "Mercado Pago aplica sus propias comisiones por operación",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "Después de los 3 años, el hosting se renueva con pago",
      "Dominio privado disponible por separado con pago anual",
      "Las plataformas de pago aplican sus propias comisiones",
    ],
